...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] vecno_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] vecno_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] vecno_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] vecno_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(vecno_metrics_core::error::Error),
