    ...
    async fn display_help(self: Arc<Self>, ctx: Arc<VecnoCli>, _argv: Vec<String>) -> Result<()> {
        ctx.term().help(
            &[
                ...
                ("start", "Start the local Vecno node instance"),
                ("stop", "Stop the local Vecno node instance"),
                ("restart", "Restart the local Vecno node instance"),
                ("kill", "Kill the local Vecno node instance"),
                ("status", "Get the status of the local Vecno node instance"),
