...
use vecno_wallet_core::storage::{make_filename, Hint};

pub(crate) async fn create(ctx: &Arc<VecnoCli>, name: Option<&str>, import_with_mnemonic: bool) -> Result<()> {
    let term = ctx.term();
