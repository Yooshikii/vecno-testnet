//!
//! Declares the client-side [`Transaction`] type, which represents a Vecno transaction.
//!
...
use vecno_consensus_core::network::NetworkTypeT;
use vecno_consensus_core::subnets::{self, SubnetworkId};
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<vecno_addresses::AddressArrayT> {
