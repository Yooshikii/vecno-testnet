...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xe6, 0x76, 0x8a, 0x70, 0x6f, 0xba, 0xaa, 0xa2, 0x09, 0xe4, 0xde, 0x45, 0x28, 0xc7, 0xe8, 0x4e, 0x3b, 0xd4, 0x09, 0xe0, 0x9a,
        0x52, 0xef, 0x0a, 0xca, 0x28, 0x46, 0xc0, 0x11, 0x68, 0x12, 0x8e,
    ]),
    version: 0,
