...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x00, 0x00, 0xa3, 0xd4, 0x70, 0x57, 0x75, 0x7e,
        0xf0, 0x4e, 0xe3, 0x64, 0x18, 0x7a, 0xb5, 0x14,
        0x63, 0x29, 0x73, 0xe9, 0x8e, 0xab, 0x31, 0x59,
        0x0f, 0xdb, 0xd4, 0xba, 0x0f, 0x71, 0xb9, 0x3d,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0xe0, 0xc0, 0x6d, 0x08, 0x9d, 0xc5, 0xbf, 0x19,
        0x34, 0xe2, 0xca, 0x25, 0xdc, 0x5e, 0x4f, 0xc5,
    ...
    utxo_commitment: Blake2Hash::from_bytes([
        ...
        0x80, 0x56, 0xba, 0xae, 0x3e, 0x24, 0x4a, 0x70,
    ]),
    timestamp: 0x664681e0,
    bits: 0x1e007fff,
    nonce: 0x0000a335,
    daa_score: 0,
    #[rustfmt::skip]
    coinbase_payload: &[
        ...
        0x00, 0x00, 0x01, 0x00, 0x65, 0x74, 0x65, 0x72,
        0x6e, 0x61, 0x6c, 0x6c, 0x79, 0x2c, 0x20, 0x66,
        0x6f, 0x72, 0x20, 0x65, 0x76, 0x65, 0x72,
    ], // eternally, for ever
};
...
mod tests {
    ...
    fn print_all_new_genesis_hash() {
        ...
        let hash_merkle_root = calc_hash_merkle_root(block.transactions.iter());
        // computer block hash
