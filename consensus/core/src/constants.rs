...
/// SompiPerVecno is the number of sompi in one vecno (1 VE).
pub const SOMPI_PER_VECNO: u64 = 100_000_000;

/// The parameter for scaling inverse VE value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = SOMPI_PER_VECNO * 10_000;

/// MaxSompi is the maximum transaction amount allowed in sompi.
pub const MAX_SOMPI: u64 = 20_000_000_000 * SOMPI_PER_VECNO;
