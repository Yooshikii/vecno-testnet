...
use vecno_hashes::{Hash, KHeavyHash};
...
mod tests {
    ...
    fn test_heavy_hash() {
        let expected_hash = Hash::from_bytes([
            0xb3, 0x68, 0x7d, 0x5b, 0x06, 0xa1, 0x7d, 0x2e, 0x5a, 0x8c, 0x7f, 0xf1, 0x10, 0x72, 0xb5, 0xa6, 0x14, 0x2e, 0xea, 0x91,
            0x2c, 0x76, 0x91, 0xcc, 0xf3, 0xb3, 0xb2, 0x6a, 0x0f, 0x99, 0xe9, 0x47,
        ]);
        #[rustfmt::skip]
