...
//! since the syncee no longer uses them in the vecno-testnet design where the full sub-DAG is sent
//!
...
use vecno_p2p_lib::{
    ...
    pb::{
        self, vecnod_message::Payload, BlockWithTrustedDataV4Message, DoneBlocksWithTrustedDataMessage, PruningPointsMessage,
        TrustedDataMessage,
    },
