//! # RPC Core
//!
//! This crate provides foundational primitives used in Rusty Vecno node RPC subsystem.
...
//!
//! This crate acts as a foundation for [`vecno_grpc_client`](https://docs.rs/vecno_grpc_client) and
//! [`vecno_wrpc_client`](https://docs.rs/vecno_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/vecno-wrpc-client/latest/vecno_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
