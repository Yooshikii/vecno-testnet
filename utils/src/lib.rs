...
/// struct MyStructVec {
///     #[serde(with = "vecno_utils::serde_bytes")]
///     v: Vec<u8>,
/// }
...
///     }
/// }
/// impl vecno_utils::hex::FromHex for MyStruct {
...
///     }
/// }
/// vecno_utils::serde_impl_ser_fixed_bytes_ref!(MyStruct, 20);
/// vecno_utils::serde_impl_deser_fixed_bytes_ref!(MyStruct, 20);
///
...
/// #[derive(Debug, Clone, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
/// struct TestStruct {
///     #[serde(with = "vecno_utils::serde_bytes_fixed_ref")]
///     v: MyStruct,
/// }
///
