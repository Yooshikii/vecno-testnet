...
use vecno_core::vecnod_env::version;
...
impl Args {
    ...
    #[cfg(feature = "devnet-prealloc")]
    pub fn generate_prealloc_utxos(&self, num_prealloc_utxos: u64) -> vecno_consensus_core::utxo::utxo_collection::UtxoCollection {
    ...
    let cmd = Command::new("vecnod")
        ...
        .arg(
            Arg::new("rpclisten")
                ...
                .help("Interface:port to listen for gRPC connections (default port: 7110, testnet: 7210)."),
        )
        .arg(
            Arg::new("rpclisten-borsh")
                ...
                .help("Interface:port to listen for wRPC Borsh connections (default port: 8110, testnet: 8210)."),
        ...
        .arg(
            Arg::new("rpclisten-json")
                ...
                .value_parser(clap::value_parser!(WrpcNetAddress))
                .help("Interface:port to listen for wRPC JSON connections (default port: 9110, testnet: 9210)."),
        )
        ...
        .arg(
            Arg::new("listen")
                ...
                .require_equals(true)
                .value_parser(clap::value_parser!(ContextualNetAddress))
                .help("Add an interface:port to listen for connections (default all interfaces port: 7111, testnet: 7211)."),
        )
        .arg(
            Arg::new("outpeers")
                .long("outpeers")
...
/*
  ...
  -a, --addpeer=                            Add a peer to connect with at startup
      ...
      --whitelist=                          Add an IP network or IP that will not be banned. (eg. 192.168.1.0/24 or
                                            ::1)
      --rpclisten=                          Add an interface/port to listen for RPC connections (default port: 7110,
                                            testnet: 7210)
      ...
      --rpckey=                             File containing the certificate key (default:
                                            /Users/aspect/Library/Application Support/Vecnod/rpc.key)
  ...
  -d, --loglevel=                           Logging level for all subsystems {trace, debug, info, warn, error,
      ...
      --minrelaytxfee=                      The minimum transaction fee in VE/kB to be considered a non-zero fee.
                                            (default: 1e-05)
